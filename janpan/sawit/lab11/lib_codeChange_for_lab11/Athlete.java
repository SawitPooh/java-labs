...
//Things that change in this lab
...
public class Athlete implements Serializable {
    ...
    public Athlete(String name, double weight, double height, Gender gender, String nationality, String birthdate) {
        ...
        this.birthdate = birthdate;// change instance birthdate  to birthdate  from parameter.
        DateTimeFormatter  formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");// this formatter object has pattern dd/MM/yyyy .
        date_of_birth = LocalDate.parse(birthdate, formatter);// this parameter birthday will change pattern to
        // yyyy-MM-dd .
    }
    ...
    public void setHeight(double height) {
        // this method will change current height attribute to new height from
        // parameter.
        this.height = height;
    }
    ...
    /*public String getBirtdate(String birthdate) {
        ...
        formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");// this formatter object has pattern dd/MM/yyyy .
        date_of_birth = LocalDate.parse(birthdate, formatter);// this parameter birthday will change pattern to
                                                              // yyyy-MM-dd .
    ...
    public String toString() {
        ...
        return String.format("Athlete [%s, %skg, %sm, %s, %s, %s]", name, weight, height, gender, nationality,
                birthdate);
