...
/*
 * This GUI Program AthleteFormV13 will show interface more information than AthleteFormV12.
...
public class AthleteFormV13 extends AthleteFormV12 {
    ...
    public static void createAndShowGUI() {
        AthleteFormV13 athleteV13 = new AthleteFormV13("Athlete Form V13");// declare object to use for instance method
    ...
    public void check_athlete() {
        ...
        try {
            ...
            if (weight_athleteDouble <= 0.0) {
                throw new NumberFormatException("Weight should be greater than 0");
            } else if (weight_athleteDouble > 200.0) {
                throw new NumberFormatException("Weight should be less than 200.0");
            }
        ...
        try {
            ...
            if (height_athleteDouble <= 0.0) {
                throw new NumberFormatException("Height should be greater than 0");
            } else if (height_athleteDouble > 300.0) {
                throw new NumberFormatException("Height should be less than 300.0");
            }
        } catch (NumberFormatException exception) {
            JOptionPane.showMessageDialog(null, "Please enter a valid number for height.\n" + exception.getMessage());
            return;
        }
