 ...
 * 4.When the player has to enter 1 or 2 to play the game. If the other keys are entered, the program shows an error message, then asks the player to enter again .
 * 5.When the player has to enter “h” or “l” for high or low. Note that the program should accept both “h” and “H”, and “l” and “L”. If the other keys are entered, the program shows an error message, then asks the player to enter again.
 * 6.When the player has to enter a number between 1 to 6. If the other keys are entered, the program shows an error message, then asks the player to enter again.
 * 7.This program have Game Play Summary.
 * 
 * Enter your choice: 1 //
...
public class SicBoV4 {
            ...
            while (true) {
                ...
                if (type_high_low.equalsIgnoreCase("h")) {
                    ...
                    if (total_dice >= 11) {
                        ...
                        gameresult("You win 20 Baht.");
                        break;
                    } else {
                        System.out.println("You lose 10 Baht.");
                        gameresult("You lose 10 Baht.");
                        break;
                    }
    ...
    public static void gameplay(String input) {
        currentInput++;
        for (int i = currentInput; i <= currentInput; i++) {
            gamePlay[i] = input;
        }
    }

    public static void gameresult(String prize) {
        for (int i = currentInput; i <= currentInput; i++) {
            gameResult[i] = prize;
        }
    }
