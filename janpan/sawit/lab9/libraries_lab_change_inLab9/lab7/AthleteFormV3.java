...
public class AthleteFormV3 extends AthleteFormV2 {
    ...
    protected JMenuItem newItem, openItem, saveItem, red, exit, green, blue, num16, num20, num24;// Declare instance attribute use.
    ...
    public static void createAndShowGUI() {
        AthleteFormV3 athleteV3 = new AthleteFormV3("Athlete Form V3");// declare object to use for instance method cause in this static method can't use.
    ...
    public void addMenus() {
        ...
        newIcon = new ImageIcon(getClass().getResource("../lab7/Iconpicture/New-icon.png"));// get icon picture from directory.
