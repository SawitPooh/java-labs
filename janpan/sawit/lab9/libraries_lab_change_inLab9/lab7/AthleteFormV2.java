...
public class AthleteFormV2 extends AthleteForm {
    ...
    protected JPanel main_panel, nation_panel, bio_panel, sport_panel, moreInfo_panel, grid_panel;// Declare instance attribute to use.
    protected JComboBox nationbox;
    protected JTextArea bio_textarea;
    protected JScrollPane bio_ScrollPane;
    protected JList<String> sport_Jlist;
    protected String nationalities[] = { "American", "Chinese", "Indonesia", "Japanese", "Thai", "Vietnamese" };
    ...
    public void addComponents() {
        ...
        nationbox = new JComboBox(nationalities);
        ...
        sport_Jlist = new JList<>(sport_list);//add list to Jlist
