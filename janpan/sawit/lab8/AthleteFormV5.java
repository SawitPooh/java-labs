...
public class AthleteFormV5 extends AthleteFormV4 {
    ...
    public void addComponents() {
        ...
        name_feild.setBackground(color_textfeild);
        weight_feild.setBackground(color_textfeild);
        height_feild.setBackground(color_textfeild);
        birth_feild.setBackground(color_textfeild);
        // set font all label
