...
public class BadmintonPlayer extends Athlete {
    ...
    public void compareAge(Athlete athlete) {
        ...
        //if athlete age's is more than ratchanok age's will output older .
        //if athlete age's is less than ratchanok age's will output younger .
        if (year_apart > 0) {
            System.out.println(athlete.name + " is " + year_apart + " years older than " + name);
        }
        else {
            year_apart *= (-1);
            System.out.println(athlete.name + " is " + year_apart + " years younger than " + name);
        }
    }
